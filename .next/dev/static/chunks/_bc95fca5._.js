...
function Page() {
    ...
    async function onSubmit(values) {
        ...
        setSuccess(null);
        try {
            const res = await fetch(`${("TURBOPACK compile-time value", "https://testapi.ordrat.com")}/api/Auth/ForgetPassword`, {
                method: 'POST',
                headers: {
...
_s(Page, "qdlJDOWV3zeNZw9Gf0yvScBVSsg=", false, function() {
    return [
...
//# sourceMappingURL=_bc95fca5._.js.map