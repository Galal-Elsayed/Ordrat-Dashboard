...
function Page() {
    ...
    async function handleVerify() {
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Code verified! Set your new password.');
    ...
    async function handleResend() {
        ...
        try {
            ...
            if (!res.ok) {
                const data = await res.json().catch(()=>({}));
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(data.message ?? 'Failed to resend code. Please try again.');
                return;
            }
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('A new verification code has been sent to your inbox.');
            setOtp('');
            setResendCooldown(60);
        } catch  {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Service unavailable. Please try again later.');
        } finally{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c917ee27._.js.map